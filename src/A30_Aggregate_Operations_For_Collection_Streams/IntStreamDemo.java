package A30_Aggregate_Operations_For_Collection_Streams;
...
public class IntStreamDemo {
    public static void main(String[] args) {
        ...
        System.out.println("The sum of first 4 numbers is " +
                IntStream.of(values)
                        .limit(4)
                        .sum());
        ...
        System.out.println("Total character count of all names is " +
                Stream.of(names)
                        .mapToInt(e -> e.length())
                        .sum());

        System.out.println("The number of digits is array values is " +
                Stream.of(values)
                        .map(e -> e + "")
                        .mapToInt(e -> e.length())
                        .sum());
